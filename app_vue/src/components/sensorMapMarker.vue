  ...
  <l-popup class="popup">
    <div class="d-flex direction-row">
      ...
      <section class="bin-details">
        ...
        <div
          class="bin-details__address color-cyan-blue"
          v-if="props.sensor.address_line1 || props.sensor.address_line2"
        >
        ...
        <div
          class="bin-details__group"
          v-if="props.sensor.group"
        >
        ...
        <div class="bin-details__volume_and_type">
          <div
            class="bin-details__bin-volume"
            v-if="props.sensor.bin_volume"
          >
            <span class="color-gray-grey">Bin Volume</span>
            {{ props.sensor.bin_volume }}
          </div>
          <div
            class="bin-details__bin-type"
            v-if="props.sensor.bin_type && props.sensor.bin_type.length"
          >
        ...
        <div
          class="bin-details__tag-list"
          v-if="props.sensor.asset_tag && props.sensor.asset_tag.length"
        >
      ...
      <section class="popup__sidebar">
        ...
        <div class="material-type">
          <v-img
            class="material-type__image"
            :src="getMaterialTypeIconURL(props.sensor.material_type)"
            width="40"
            height="40"
          />
    ...
    <section class="alerts-section">
      <div class="alerts">
        ...
        <div
          class="alerts__item"
          v-if="props.sensor.fill_level_alert"
        >
          <vue-feather
            size="18"
        ...
        <div
          class="alerts__item"
          v-if="props.sensor.temperature_alert"
        >
          <vue-feather
            size="18"
            class="color-green mr-2"
        ...
        <div
          class="alerts__item"
          v-if="props.sensor.illegal_dumping_alert"
        >
          <vue-feather
            size="18"
            class="color-green mr-2"
        ...
        <div
          class="alerts__item"
          v-if="props.sensor.contamination_alert"
        >
          <vue-feather
            size="18"
            class="color-green mr-2"
      ...
      <div
        ...
        v-if="props.sensor.last_collected"
      >
        ...
        <div class="last-collected__item">
          ...
          <span v-if="props.sensor.fill_level_last_collected">at {{ props.sensor.fill_level_last_collected }}% full</span>
        </div>
      </div>
    </section>
