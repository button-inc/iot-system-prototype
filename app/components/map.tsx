...
const Map: React.FC<Props> = ({ sensors, fillLevelThreshold }) => {
  ...
  const points = sensors.map((sensor) => {
    return (
      <SensorMarker
        key={sensor.id}
        sensorToMark={{...sensor, address_line1: '1150 Queen St W', address_line2: 'Toronto, ON M6J 1J3', group: 'Toronto West', bin_type :'EMW Cathedral Container 10yd', material_type: 'Cardboard' }}
